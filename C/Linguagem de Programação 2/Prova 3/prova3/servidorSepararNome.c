...
void *funcaoCliente(void *valor)
{
    ...
    while (true)
    {
        ...
        for (int i = 0; i < strlen(buffer); i++)
        {
            ...
            {
                mensagemServidor[strlen(mensagemServidor)] = 'A';
            }
            else if (buffer[i] == 'e'|| buffer[i] == 'E')
            {
                mensagemServidor[strlen(mensagemServidor)] = 'E';
            }
            else if (buffer[i] == 'i' || buffer[i] == 'I')
            {
                mensagemServidor[strlen(mensagemServidor)] = 'I';
            }
            else if (buffer[i] == 'o' || buffer[i] == 'O')
            {
                mensagemServidor[strlen(mensagemServidor)] = 'O';
            }
            else if (buffer[i] == 'u' || buffer[i] == 'U')
            {
                mensagemServidor[strlen(mensagemServidor)] = 'U';
            }
        }
