...
/*
    2) A sequência de Fibonacci tem papel importante na explicação de fenômenos 
...
int main(void){
    ...
    int num_1 = 1, num_2 = 1, num_3, n;

    printf("Quantos elementos da Sequencia de Fibonacci deseja ver? ");
    scanf("%d", &n);
