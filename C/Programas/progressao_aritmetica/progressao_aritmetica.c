...
/*
    4) Faça um programa em Cque peça um número inteiro inicial ao usuário, um valor
...
int main(void){
    ...
    for(int i = 1; i <= 10; i++){
        printf(cor_verde "%2d" cor_branca " +", TI);
        printf(cor_amarela "%2d" cor_branca " *", razao);
        printf(cor_magenta "%2d" cor_branca " = ", i);
        printf(cor_azul "%2d\n" cor_branca, TI + i * razao);
    }
